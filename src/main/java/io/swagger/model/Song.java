...
public class Song {
   ...
   * @return songName
   **/
  @Schema(example = "Gangam Style", description = "Name of the song")
  
  @Size(min=1)   public String getSongName() {
    return songName;
  }
   ...
   * @return artist
   **/
  @Schema(example = "Psy", description = "Name of song artist")
  
  @Size(min=1)   public String getArtist() {
    return artist;
  }
   ...
   * @return year
   **/
  @Schema(example = "2016", description = "Year the song came out")
   ...
   * @return price
   **/
  @Schema(example = "3", description = "Price of the song")
   ...
   * @return songFile
   **/
  @Schema(example = "gangamStyle.mp3", description = "File containing the song but for now is just a string")
  
  @Pattern(regexp="\\w+\\.mp3")   public String getSongFile() {
    return songFile;
  }
